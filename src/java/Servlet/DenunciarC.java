 ...
 * @author aaper
 */
public class DenunciarC extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try  {
            ...
            if(setDenunciaComentario(id, 1, usuario))
    ...
    private static boolean setDenunciaComentario(int idComentario, int tipo, java.lang.String usuario) {
        ...
        return port.setDenunciaComentario(idComentario, tipo, usuario);
    }
